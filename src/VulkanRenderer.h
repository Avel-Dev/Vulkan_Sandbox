...
public:
     ...
     */
    [[nodiscard]] auto wasResized() const noexcept -> bool { return framebufferResized_; }

    /**
     * @brief Set framebuffer resize flag
     */
    void setResized(bool resized) noexcept { framebufferResized_ = resized; }
...
private:
    ...
    [[nodiscard]] auto querySwapChainSupport(VkPhysicalDevice device) const -> SwapChainSupportDetails;
    ...
    [[nodiscard]] auto chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& formats) const
        -> VkSurfaceFormatKHR;
